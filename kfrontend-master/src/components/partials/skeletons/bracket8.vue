	...
	<div class="relative min-w-[100vw] print:w-[1920px] min-h-[100vh] print:h-[1080px]">
		...
		<div class="bg-white p-2 pt-0">
			<div class="flex flex-row mt-4 space-x-10">
				<p class="w-[25rem] tournament-stage">{{ t("quarter") }}</p>
				<p class="w-[25rem] tournament-stage relative top-14">{{ t("semi") }}</p>
				<p class="w-[25rem] tournament-stage relative top-40">{{ t("final") }}</p>
			</div>

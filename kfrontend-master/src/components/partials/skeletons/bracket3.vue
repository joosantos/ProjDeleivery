<template>
	<div class="relative min-w-[100vw] print:w-[1920px] min-h-[100vh] print:h-[1080px]">
		...
		<div class="bg-white p-2 relative min-h-screen">
			<div class="flex flex-row space-x-10 mt-4 ml-2">
				<p class="w-[40rem] tournament-stage relative">{{ t("final") }}</p>
			</div>
			<div class="flex flex-row">
				<div class="flex flex-col bg-white space-y-4">
					<SingleMatch :tournament="props.tournament" :number="1" :width="width" />
					<SingleMatch :tournament="props.tournament" :number="2" :width="width" />
					<SingleMatch :tournament="props.tournament" :number="3" :width="width" />
				</div>
			</div>
		</div>
